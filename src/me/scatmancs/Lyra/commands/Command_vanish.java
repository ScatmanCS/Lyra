  ...
  implements CommandExecutor, TabCompleter
{
  ...
  public boolean onCommand(CommandSender sender, Command command, String label, String[] arguments)
  {
    if ((sender instanceof Player))
    {
      ...
      if (player.hasPermission("lyra.command.vanish"))
      {
        ...
        else if (this.utilities.getStaffModeListener().isVanished(player))
        {
          ...
          player.sendMessage(new ColorHandler().translate("&eYour vanish has been &cdisabled&e."));
        }
        else
        {
          this.utilities.getStaffModeListener().setVanished(player, true);
          player.sendMessage(new ColorHandler().translate("&eYour vanish has been &aenabled&e."));
        }
      }
      else {
