...
public final class JavaUtils {
    private static final CharMatcher CHAR_MATCHER_ASCII = CharMatcher.inRange((char) '0', (char) '9')
                                                                     .or(CharMatcher.inRange((char) 'a', (char) 'z'))
                                                                     .or(CharMatcher.inRange((char) 'A', (char) 'Z'))
    ...
    public static String format(Number number, int decimalPlaces, RoundingMode roundingMode) {
        ...
        return new BigDecimal(number.toString()).setScale(decimalPlaces, roundingMode)
                                                .stripTrailingZeros()
                                                .toPlainString();
    }
